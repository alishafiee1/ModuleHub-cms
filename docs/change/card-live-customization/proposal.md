...
> **جدا از:** [1405-03-24-folder-card-management](../1405-03-24-folder-card-management/proposal.md) (مدیریت پوشه — ✅ بسته).  
> **فاز ۴ استاتیک (iframe + card.html)** از آن change **معلق** شد — [archive](../../archive/1405-03-24-static-card-template-suspended/proposal.md). این change **روش جدید یکپارچه** برای تکمیل دیزاین کارت‌ها را تعریف می‌کند.

---

## §۱ چرا این change جداست؟

در change قبلی ([folder-card-management](../1405-03-24-folder-card-management/proposal.md)) کارت می‌توانست **توضیح مارک‌داون** و **مدیریت پوشه** داشته باشد. ایدهٔ **قالب HTML ثابت** (iframe + `card.html`) **معلق** شد — [archive](../../archive/1405-03-24-static-card-template-suspended/proposal.md).

اینجا می‌خواهیم **روش واحد** برای کارت‌های غنی‌تر از آیکون+عنوان بسازیم: دادهٔ زنده، HTML پویا، و درگاه CMS — بدون کپی مستقیم پلن معلق‌شده.
